  ...
  <div>
    <section className="relative pt-40 pb-20 px-6 md:px-10 grain-overlay">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0}>
          <p className="text-[10px] tracking-[0.4em] uppercase text-primary mb-4 font-semibold">Our Roster</p>
          ...
          <p className="text-muted-foreground text-lg max-w-2xl leading-relaxed">
            Meet the visionary artists and creators who call URS79 home.
          </p>
        </motion.div>
      </div>
    </section>
    ...
    <section className="section-padding">
      <div className="max-w-[1400px] mx-auto">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0} className="text-center mt-20">
          <p className="text-muted-foreground text-sm mb-2">Our artist roster is being built.</p>
          <p className="text-[10px] tracking-[0.3em] uppercase text-primary font-semibold">Announcements coming soon</p>
        </motion.div>
      </div>
    </section>
